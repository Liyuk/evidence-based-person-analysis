...
欢迎为 RelationForge 补充边界修正、分析流程改进、宿主兼容反馈、翻译和评估案例。两个 Skill 都应依据具体材料说明判断依据和未知，并把决定权留给当事人：`interaction-risk-analysis` 侧重诈骗、操控、胁迫、虐待和霸凌中的互动风险；`person-deep-analysis` 侧重自述、个人介绍、选取的聊天/互动材料及虚构角色的有限解读。
