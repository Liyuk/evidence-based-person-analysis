...
|---|---|---|---|
| 本项目 `person-deep-analysis` | 当前提供的个人材料、聊天片段、虚构角色；另支持疑似诈骗/胁迫情境的有限应对 | 8 条启发式 → 核实问题 → M1–M5；按需读取文学、心理学或反诈支持参考 | 26 个行为场景；结构校验、独立指令前测、Codex CLI 烟雾测试及三例 A/B 试跑；单模型评分且评审不一致，未做人工双人盲评或用户研究 |
